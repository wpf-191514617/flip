...
import com.awhh.everyenjoy.library.db.ManyToOneLazyLoader;
import com.awhh.everyenjoy.library.db.annotate.Table;
...
public class ClassUtils {
    ...
    public static String getPrimaryKeyColumn(Class<?> clazz) {
        ...
        if (fields != null) {
            com.awhh.everyenjoy.library.db.annotate.Id idAnnotation = null;
            Field idField = null;
